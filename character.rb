...
hero1 = Character.new("Harry Potter", 100, "Howgarts Wizard")
hero2 = Character.new("Hermione Granger", 100, "Hogwarts Wizard")
hero3 = Character.new("Ron Weasley", 100, "Hogwarts Wizard")
